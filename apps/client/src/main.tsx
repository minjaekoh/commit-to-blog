  ...
  React.useEffect(() => {
    void (async () => {
      try {
        ...
        const savedPosts = await apiGet<PostCard[]>('/posts');
        setPosts(savedPosts);
      } catch (e) {
